...
<tr>
  ...
  <td><input type="text" style="width: 320px; padding: 2px" name="pref_numInfrastructures" id="numInfras" disabled="true" value="<%=pref_numInfrastructures %>"></td>
</tr>
<tr>
...
<tr>
  ...
  <td><input type="text" style="width: 320px; padding: 2px" name="pref_jobRequirements" id="jobRequirements" value="<%=pref_jobRequirements %>"></td>  
</tr>
<tr>    
